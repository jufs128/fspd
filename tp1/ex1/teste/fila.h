...
//Variáveis da fila
extern int comeco;   //Começo da fila
extern int tamanho;  //Tamanho da fila (número de elementos)
extern int max_fila; //Tamanho máximo que a fila pode alcançar
extern fractal_param_t *fila; //Array da fila circular das tarefas
